...
/**
 * @file stats.c 
 * @brief Performs statistic analysis on a given dataset. 
 *
 * It contains functions that aims to calculate statistic operations such as
 *the max, min, mean and median function of a given array. 
